...
const Tab0 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit">
      <h3 className="text-4xl font-recoleta font-bold mb-6">Machine Learning Modeling</h3>
      <p className="text-xl font-light">
        We integrate <span className="font-recoleta font-bold">machine learning algorithms</span>,
        time series analysis, predictive modeling techniques, and dynamic data visualization to
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            ...
            <li className="pb-2">
              Handling large and complex datasets effectively, daily and continuously.
            </li>
            <li className="pb-2">
              Detecting patterns and anomalies in critical parts of your business.
            </li>
          </ul>
        </div>
        <div className="basis-5/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            <li className="pb-2">
              Developed LLM-based systems with dimensionality reduction for skill categorization.
            </li>
      ...
      <div className="mt-14">
        ...
        <div className="project-card">
          ...
          <div className="flex flex-col flex-1 justify-between p-2 bg-zinc-200 dark:bg-zinc-900">
            <div>
              <p className="text-sm">MACHINE LEARNING / INDUSTRIAL ANOMALY DETECTION</p>
              <p className="text-lg mt-1">
                Implemented predictive maintenance using time series data to detect equipment
                anomalies, reducing downtime by 30%.
              </p>
              <br />
            </div>
...
const Tab1 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit mt-20">
      <h3 className="text-4xl font-recoleta font-bold mb-6">Web & Mobile App Development</h3>
      <p className="text-xl font-light">
        We specialize in creating high-performance web and mobile applications. Ensuring a stable
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            ...
            <li className="pb-2">
              Enhancing user engagement with real-time features and push notifications.
            </li>
        ...
        <div className="basis-5/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            ...
            <li className="pb-2">
              Implemented web3 applications with crypto payment integration and smart contract
              interactions.
            </li>
            <li className="pb-2">
              Unlocked push notifications, campaigns, and promo codes with friendly dashboards.
            </li>
            <li className="pb-2">
              Programmed complex event tracking systems for user behavior analysis.
            </li>
            <li className="pb-2">Integrated Chromecast and Apple AirPlay features.</li>
            <li className="pb-2">
              Built real-time apps that react instantly to underlying data changes.
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className="project-card">
          ...
          <div className="flex flex-col flex-1 justify-between p-2 bg-zinc-200 dark:bg-zinc-900">
            <div>
              ...
              <p className="text-lg mt-1">
                Enhanced user engagement by integrating push notifications into the app, achieving a
                10% engagement rate compared to 1% with traditional email campaigns.
              </p>
              <br />
            </div>
            <div className="flex gap-2">
...
const Tab2 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit mt-20">
      <h3 className="text-4xl font-recoleta font-bold mb-6">Voice AI & Custom Audio Solutions</h3>
      <p className="text-xl font-light">
        We have extensive experience working with both male and female voices, creating customized
        vocal profiles with specific names and emotional tones. Our expertise includes integrating
        moods into speech, as well as working with subtitles and subtitle synchronization, ensuring
        precise timing even with the inclusion of custom voices.
      </p>
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
          <h4 className="text-xl pb-4">YOUR CHALLENGES</h4>
...
const Tab3 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit mt-20">
      ...
      <p className="text-xl font-light">
        We have harnessed advanced AI vision technologies to create customizable scenes for
        children&apos;s stories, utilizing workflows in{' '}
        <span className="font-recoleta font-bold">ComfyUI</span> to perform face swaps and apply
        animated styles to generated images. Our expertise extends to generating themed backgrounds
        and executing large-scale production with over 150+ GPUs, including L40 and RTX 4090, in a
        distributed system managed through worldwide geo load balancing.
      </p>
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
          <h4 className="text-xl pb-4">YOUR CHALLENGES</h4>
          <ul className="list-disc text-md text-gray-300 font-light">
            ...
            <li className="pb-2">
              Implementing advanced AI vision solutions in production environments.
            </li>
        ...
        <div className="basis-5/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            <li className="pb-2">
              Advanced workflows in ComfyUI using LoRAs for style modification and subject
              injection.
            </li>
            <li className="pb-2">
              Fine-tuning models with Auto1111 and Kohya for Dreambooth customization.
            </li>
            ...
            <li className="pb-2">
              Experience in Kaggle competitions (e.g., lung cancer detection, seal counting in drone
              photos).
            </li>
          </ul>
        </div>
        ...
        <div className="project-card">
          ...
          <div className="flex flex-col flex-1 justify-between p-2 bg-zinc-200 dark:bg-zinc-900">
            <div>
              ...
              <p className="text-lg mt-1">
                Deployed complex ComfyUI workflows at scale, utilizing over 150 GPUs to generate
                customizable scenes with dynamic face swaps and animated styles for children&apos;s
                stories.
              </p>
            </div>
            <div className="flex gap-2">
...
const Tab4 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit mt-20">
      <h3 className="text-4xl font-recoleta font-bold mb-6">AI Text & Language Models</h3>
      <p className="text-xl font-light">
        We have extensive experience working with both third-party services and self-hosted
        solutions, specializing in chat and embedding-based Retrieval-Augmented Generation (RAG)
        systems. Our team has created multi-step LLM-enhanced systems to generate content for
        financial news, scientific publications, and character impersonation, delivering advanced AI
        text solutions.
      </p>
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            ...
            <li className="pb-2">
              Implementing advanced AI text solutions tailored to your needs.
            </li>
        ...
        <div className="basis-5/12">
          ...
          <ul className="list-disc text-md text-gray-300 font-light">
            <li className="pb-2">
              Development of multi-step LLM-enhanced content generation systems.
            </li>
            <li className="pb-2">Experience with chat and embedding-based RAG systems.</li>
            <li className="pb-2">
              Creating AI-generated content for financial news and scientific materials.
            </li>
            <li className="pb-2">
              Designing character impersonation models for interactive applications.
            </li>
...
const Tab5 = ({ id, isInView }: { id: string; isInView: () => void }) => {
  ...
  return (
    <div ref={ref} id={id} className="font-favorit mt-20">
      ...
      <p className="text-xl font-light">
        We have worked extensively with complex data visualizations at scale, primarily for
        financial SaaS platforms. Our expertise includes building heatmaps with candlestick charts
        overlay, live order book histograms, calendars, and timelines—all with interactive options
        and multiple granularities. We have also developed geo-data visualizations to provide
        spatial insights.
      </p>
      <div className="flex flex-col sm:flex-row justify-between gap-6 mt-14">
        <div className="basis-6/12">
        ...
        <div className="project-card">
          ...
          <div className="flex flex-col flex-1 justify-between p-2 bg-zinc-200 dark:bg-zinc-900">
            <div>
              ...
              <p className="text-lg mt-1">
                Developed an interactive financial dashboard featuring real-time heatmaps with
                candlestick charts.
              </p>
            </div>
            <div className="flex gap-2">
...
const tabsMenu = [
  {
    ...
    icon: '/dd-gifs/gif_0_white.gif',
    iconDark: '/dd-gifs/gif_0_black.gif'
  },
  {
    label: 'web + mobile apps',
    icon: '/dd-gifs/gif_5_white.gif',
    iconDark: '/dd-gifs/gif_5_black.gif'
  },
        ...
        <div className="basis-4/12">
          ...
          <StickyBox offsetTop={15}>
            <p className="text-xl font-favorit font-light">
              Our team connects skills that are usually compartmentalized:{' '}
              <span className="font-recoleta font-bold">Advanced Machine Learning</span> Modeling,{' '}
              <span className="font-recoleta font-bold">Web + Mobile</span> App Development, DevOps,{' '}
              <span className="font-recoleta font-bold">AI voice </span>,{' '}
              <span className="font-recoleta font-bold">AI vision</span>,
              <span className="font-recoleta font-bold"> AI text processing</span> and data
              visualization.
              <br />
            </p>
